				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-6 col-md-4">
						<div class="widget subscribe no-box">
							...
							<p>Cinema Tickets Booking Website By Nguyen Cong Huy PTIT <3
							</p>
						</div>
					</div>
					...
					<div class="col-xs-12 col-sm-6 col-md-4">
						<div class="widget no-box">
							...
							<a class="btnn"
								href="https://www.youtube.com/channel/UCFrF4obG4U2Kef-ZneGIGvA"
					...
					<div class="col-xs-12 col-sm-6 col-md-4">
						...
						<div class="widget no-box">
							...
							<p>
								<a href="mailto:huync21@gmail.com" title="glorythemes">huync21@gmail.com</a>
							</p>
							<ul class="social-footer2">
								<li class=""><a title="youtube" target="_blank"
									href="https://www.youtube.com/channel/UCFrF4obG4U2Kef-ZneGIGvA"><img
								...
								<li class=""><a
									href="https://www.facebook.com/profile.php?id=100048470814493"
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-center">
						<p>Copyright HUYCINEMA 2022. All rights reserved.</p>
					</div>
				</div>
			</div>
		</div>
